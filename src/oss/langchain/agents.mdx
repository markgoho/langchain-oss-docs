...
<Tip>
To learn more about memory, including how to implement long-term memory that persists across sessions, see [Memory](/oss/langgraph/memory).
</Tip>
